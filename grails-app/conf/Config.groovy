...
environments {
    development {
        ...
        grails.config.locations = ["classpath:application_dev.properties","classpath:application.properties"]
    }
    production {
        grails.logging.jul.usebridge = false
        grails.config.locations = ["classpath:application_pro.properties","classpath:application.properties"]
...
//ck编辑器
ckeditor.upload.baseurl = "/uploads/"
ckeditor.upload.basedir = "/uploads/"

project.setting.uploadImageExts="jpg,jpeg,png,bmp"
project.setting.uploadVideoExts="mp4,mpeg4,mpg4,flv,avi,rmvb,ogv"
